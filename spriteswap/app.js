(() => {
  ...
  function renderTrades(){
    ...
    $('#tradeGrid').innerHTML=rows.length?rows.map(t=>{
      const perfect=state.session?.user.id!==t.user_id && mine.has(norm(t.want));
