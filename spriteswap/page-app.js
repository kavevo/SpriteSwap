...
async function tradePage(){
  ...
  // You may OFFER any Sprite you own, including legacy C7 S3 Sprites.
  // Only the WANTED side is limited to the current/new released catalog.
  const offerableOwnedIds=new Set(ownedIds);
