(() => {
  ...
  document.addEventListener('click',e=>{
    ...
    if(t.id==='authBtn'){e.preventDefault();e.stopImmediatePropagation();return go(t.querySelector('img')?'/profile.html':'/api/discord-login')}
    ...
    const m=t.closest('[data-message]');if(m){e.preventDefault();e.stopImmediatePropagation();return go(`/messages.html?peer=${encodeURIComponent(m.dataset.message)}&trade=${encodeURIComponent(m.dataset.trade||'')}`)}
